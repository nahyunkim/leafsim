...
public:
  ...
  void loadCloths(vector<Cloth *> *cloths);
  void loadClothParameters(vector<ClothParameters *> *cps);
...
private:
  ...
  float wind_interval = .1;
  CGL::Vector3D wind_amplitude = CGL::Vector3D (0, 10, 2);
  float current_step;
  ...
  vector<Cloth *> cloths_vector;
  vector<ClothParameters *> cps_vector;
